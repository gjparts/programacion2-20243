...
public class App {
    ...
    public static void main(String[] args) {
        ...
        //forma 3: condiciones sin el uso de else y utilizando el operador logico AND
        float venta, tasaDescuento = 0, descuento;
        Scanner s = new Scanner(System.in);
        System.out.print("Digite el monto de la venta:");
        venta = s.nextFloat();
        //calculo del descuento
        if( venta >= 2000 && venta < 5000 ) tasaDescuento = 0.10f;
        if( venta >= 5000 && venta < 10000 ) tasaDescuento = 0.20f;
        if( venta >= 10000 && venta < 20000 ) tasaDescuento = 0.30f;
